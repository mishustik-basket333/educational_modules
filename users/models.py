...
class User(AbstractUser):
    ...
    id_moderator = models.OneToOneField("Moderator", verbose_name="модератор", primary_key=True,
                                        on_delete=models.SET_NULL, **NULLABLE)
    id_teacher = models.OneToOneField("Teacher", verbose_name="преподаватель", primary_key=True,
                                      on_delete=models.SET_NULL, **NULLABLE)
